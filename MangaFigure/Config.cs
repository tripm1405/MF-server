namespace MangaFigure
{
    public static class Config
    {
        ...
        public static string IN_PRODUCTS = IN + "/Uploads/Products/";
        public static string IN_LOGOS = IN + "/Uploads/Logos/";
        public static string IN_SLIDESHOWS = IN + "/Uploads/SlideShows/";
    }
}
